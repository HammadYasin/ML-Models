...
import { IoSearchOutline, IoCloudOutline } from "react-icons/io5";
      ...
      <div style={myStyle}>
        ...
        >
          <text style={responsiveTextStyles}>
            Kindly input the necessary information to initiate the weather type
            prediction process.
          </text>
          <div
            className="container"
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  className="e-input"
                  placeholder="Enter Temperature(-50 to 50°C)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "200%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={humi}
                  onChange={(event) => setHumi(event.target.value)}
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={winds}
                  onChange={(event) => setWinds(event.target.value)}
                  placeholder="Enter Wind Speed(0 to 120 km/h)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={preci}
                  onChange={(event) => setPreci(event.target.value)}
                  placeholder="Enter Precipitation(0 to 100%)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <select
                  value={clou}
                  onChange={(event) => setClou(event.target.value)}
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={atmos}
                  onChange={(event) => setAtmos(event.target.value)}
                  placeholder="Enter Atmosphere(980 to 1050hPa)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  placeholder="Enter UV Index(0 to 13+)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={vis}
                  onChange={(event) => setVis(event.target.value)}
                  placeholder="Enter Visibility(0 to 19+km)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
