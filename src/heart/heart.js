  ...
  return (
    <div className="App">
      ...
      <div style={myStyle}>
        ...
        >
          <text style={responsiveTextStyles}>
            Kindly input the necessary information to initiate the heart attack
            prediction process.
          </text>
          <div
            className="container"
          ...
          >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={chol}
                  onChange={(event) => setChol(event.target.value)}
                  placeholder="Enter Cholestrol  (mg/dl)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={thalachh}
                  onChange={(event) => setTha(event.target.value)}
                  placeholder="Enter Heart Rate Maximum (BPM)"
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <input
                  ...
                  pattern="[0-9]*"
                  value={caa}
                  onChange={(event) => setCaa(event.target.value)}
            ...
            >
              ...
              >
                ...
                <select
                  value={exng}
                  onChange={(event) => setExn(event.target.value)}
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <select
                  value={thall}
                  onChange={(event) => setThall(event.target.value)}
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
              ...
              >
                ...
                <select
                  value={slp}
                  onChange={(event) => setSlp(event.target.value)}
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
                    fontSize: "1%vw",
                    width: "100%",
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <Lottie
                ...
                style={{ height: "auto", width: "350", maxWidth: 350 }}
              />
              <div style={{ height: 80 }}>
                {load && (
                  <Lottie
      ...
      <footer
        style={{ backgroundColor: "#2F6398", height: 30, textAlign: "center" }}
      >
        <text
          style={{
            fontFamily: "-apple-system, BlinkMacSystemFont, sans-serif",
