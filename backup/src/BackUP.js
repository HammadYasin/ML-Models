        ...
        <div className="App">
            <header style={{ backgroundColor: '#2F6398', height: 70, color: '#FFFFFF', fontSize: 50, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px' }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <text style={responsiveTextStyles1}>Heart Attack Model</text>
                </div>
            ...
            <div style={myStyle}>
    <div style={{height:'60vh',backgroundColor:'#FFFFFF',borderWidth:10,borderRadius:20,alignSelf:'center',boxShadow: '1px 2px 9px #000000',padding: '0 10px',width:'78%',flexWrap:'wrap'}}>
        ...
        <div className="container" style={{display:'flex',flexDirection:'row',width:'100%',marginTop:30,justifyContent:'space-between',alignItems:'center'}}>
            <div className="component" style={{display:'flex',flexDirection:'column',width:'100%',justifyContent:'space-between',padding:'0 20px'}}>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>  
                    <text style={{marginRight:7,fontSize:20}}>Age:</text>
                <input min="0" type='number' pattern="[0-9]*" value={age} onChange={(event) => setAge(event.target.value)} className="e-input"  placeholder="Enter Age" style={{fontSize:20,width:'100%'}} />
                </div>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>BP:</text>
                <input className="e-input" min="0" type='number' pattern="[0-9]*" value={trtbps} onChange={(event) => setTrt(event.target.value)} placeholder="Enter Blood Pressure  (mm Hg)" style={{fontSize:20,width:'100%'}} />
                </div>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>Cholestoral:</text>
                <input className="e-input" min="0" type='number' pattern="[0-9]*" value={chol} onChange={(event) => setChol(event.target.value)} placeholder="Enter Cholestrol  (mg/dl)" style={{fontSize:20,width:'100%'}} />
                </div>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>Pulse:</text>
                <input className="e-input" min="0" type='number' pattern="[0-9]*" value={thalachh} onChange={(event) => setTha(event.target.value)} placeholder="Enter Heart Rate Maximum (BPM)" style={{fontSize:20,width:'100%'}} />
                </div>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>Vessels:</text>
                <input className="e-input" min="0" type='number' pattern="[0-9]*" value={caa} onChange={(event) => setCaa(event.target.value)} placeholder="Enter Number of Major Vessels" style={{fontSize:20,width:'100%'}} />
                </div>
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>Oldpeak:</text>
                <input className="e-input" min="0" type='number' pattern="[0-9]*" value={oldpeak} onChange={(event) => setOld(event.target.value)} placeholder="Enter Previous peak" style={{fontSize:20,width:'100%'}} />
                </div>
        ...
        <div className="component" style={{display:'flex',flexDirection:'column',width:'100%',padding:'0 20px',justifyContent:'space-between',padding:'0 20px'}}>
        <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    <text style={{marginRight:7,fontSize:20}}>Gender:</text>
                    <select value={gender} onChange={(event) => setGen(event.target.value)} style={{fontSize:20,width:'100%'}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    ...
                    <select value={cp} onChange={(event) => setCp(event.target.value)} style={{fontSize:20,width:'100%'}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>
                    ...
                    <select value={fbs} onChange={(event) => setFbs(event.target.value)} style={{fontSize:20,width:'100%',height:70}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    ...
                    <select value={restecg} onChange={(event) => setRes(event.target.value)} style={{fontSize:20,width:'100%'}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    ...
                    <select value={exng} onChange={(event) => setExn(event.target.value)} style={{fontSize:20,width:'100%',height:70}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    ...
                    <select value={thall} onChange={(event) => setThall(event.target.value)} style={{fontSize:20,width:'100%',height:60}}>
                ...
                <div style={{display:'flex',flexDirection:'row',alignItems:'center',marginTop:15}}>  
                    ...
                    <select value={slp} onChange={(event) => setSlp(event.target.value)} style={{fontSize:20,width:'100%',height:60}}>
                    <option value=''>Select Thalium Stress</option>
                    <option value="0">0</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
