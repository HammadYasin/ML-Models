    ...
    return (
        <div className="App">
            ...
            <header style={{ backgroundColor: 'grey', marginTop: 20, display: 'flex', height: 40 }}>
                <text style={{ color: 'white', fontSize: 30, height: 40, backgroundColor: '#1F3B57', paddingInline: 10, fontWeight: 'bold', marginLeft: 50 }}>Heart</text>
                <text onClick={navigateDiabetes} style={{ color: 'white', fontSize: 30, paddingInline: 20 }}>Diabetes</text>
