...
function App() 
{
    ...
    return (
        <div className="App">
            <header style={{backgroundColor:'#2F6398',height:70,color:'#FFFFFF',fontSize:50,display:'flex',flexDirection:'row',alignItems:'center'}}>
                <IoHeartCircleOutline></IoHeartCircleOutline>
                <text style={{marginLeft:750}}>Heart Attack Model</text>
                <img src={background1} style={{height:60,width:60,borderRadius:8 , marginLeft:700}}></img>
            </header>
            <header style={{backgroundColor:'grey',marginTop:20,display:'flex',height:40}}>
                ...
                <text style={{color:'white',fontSize:30,paddingInline:20}}>
                    About
                </text>
                <IoSearchOutline style={{color:'white',fontSize:40,backgroundColor:'#1F3B57',marginLeft:1650}}></IoSearchOutline>
            </header>
            <div style={myStyle}>
                <div style={{height:550,width:1500,backgroundColor:'#FFFFFF',borderWidth:10,borderRadius:20,alignSelf:'center',marginLeft:250,boxShadow: '1px 2px 9px #000000' }}>
            ...
            <footer style={{backgroundColor:'#2F6398',height:30,marginTop:55}}>
